...
namespace Shopping.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(DataContext context, IUserHelper userHelper, IOrdersHelper ordersHelper, IFlashMessage flashMessage)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index(string sortOrder, string currentFilter, string searchString, int? pageNumber)
        {
            ...
            {
                Products = await PaginatedList<Product>.CreateAsync(query, pageNumber ?? 1, 8),
